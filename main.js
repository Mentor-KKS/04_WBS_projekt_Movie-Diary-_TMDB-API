...
const url = {
    ...
    // discover movies
    "discoverMovies" : "https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-GB&page=1&sort_by=popularity.desc",
    // trending movies of the day
    "trendingMovieDay" : "https://api.themoviedb.org/3/trending/movie/day?language=en-GB",
    // trending movies of the week
    "trendingMovieWeek" : "https://api.themoviedb.org/3/trending/movie/week?language=en-GB",
    // upcoming movies
